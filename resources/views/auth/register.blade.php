    ...
    <div class="relative isolate flex min-h-screen items-center justify-center overflow-hidden px-5 py-12">
        ...
        <div class="relative w-full max-w-md">
            ...
            <form action="/register" method="POST" class="rounded-3xl border border-base-300/70 bg-base-200/80 p-6 shadow-2xl shadow-black/20 backdrop-blur sm:p-8">
                ...
                <button type="submit" data-test="register" class="mt-6 h-12 w-full rounded-xl bg-primary text-sm font-semibold text-primary-content shadow-lg shadow-primary/20 transition hover:-translate-y-0.5 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-primary/25">Create account</button>
