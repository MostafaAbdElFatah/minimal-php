...
test('the view-admin gate is registered', function (): void {
    expect(Gate::has('view-admin'))->toBeTrue();
})->group('unit', 'policies');

test('the view-admin gate allows the first user and hides the page from everyone else', function (int $id, bool $allowed): void {
